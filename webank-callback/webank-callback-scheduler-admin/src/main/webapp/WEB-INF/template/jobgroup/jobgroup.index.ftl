            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form" >
                        ...
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">注册授权<font color="red">*</font></label>
                            <div class="col-sm-10">
                            	<select class="form-control" name="registId" style="width: 435px;">
			            			<#list registries as regist>
			            				<option value="${regist.id}">${regist.clientName}</option>
			            			</#list>
			                  	</select>
                            </div>
                        </div>
