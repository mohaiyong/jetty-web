...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><img src="${request.contextPath}/static/image/jt.jpg" style="width: 50px;height: 50px;"></img></span>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "jobregistry">active</#if>" ><a href="${request.contextPath}/jobregistry"><i class="fa fa-circle-o text-green"></i><span>客户端注册管理</span></a></li>
				<li class="nav-click <#if pageName == "jobReport">active</#if>" ><a href="${request.contextPath}/"><i class="fa fa-circle-o text-green"></i><span>运行报表</span></a></li>
