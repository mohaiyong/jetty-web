package com.spring.scheduler.admin.core.schedule;
...
import com.spring.scheduler.admin.core.jobbean.RemoteHttpJobBean;
import com.spring.scheduler.admin.core.model.JobInfo;
import com.spring.scheduler.admin.core.thread.JobFailMonitorHelper;
import com.spring.scheduler.admin.core.thread.JobRegistryMonitorHelper;
...
public final class JobDynamicScheduler implements ApplicationContextAware {
	...
	public static boolean addJob(String jobName, String jobGroup, String cronExpression) throws SchedulerException {
        ...
        // CronTrigger : TriggerKey + cronExpression	// withMisfireHandlingInstructionDoNothing ���Ե�������ֹ����к��Եĵ���
