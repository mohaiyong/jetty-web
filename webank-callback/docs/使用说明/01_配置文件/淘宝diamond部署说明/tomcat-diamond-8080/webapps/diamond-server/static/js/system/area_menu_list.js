...
$(function() {
	function rowformater(value,row,index){
		...
		}else if(row.funCode == null || $.trim(row.funCode) == '' || typeof(row.funCode) == 'undefined'){
	...
	var checkFunCode = function(url,type){
