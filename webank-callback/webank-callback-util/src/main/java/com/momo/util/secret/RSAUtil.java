...
public class RSAUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		//1.公钥加密
		byte[] dataByte = RSAUtil.encryptByPublicKey(data.getBytes("utf-8"), publicKey);

		//2.私钥解密
		data = new String(RSAUtil.decryptByPrivateKey(dataByte, privateKey), "utf-8");
		System.out.println("私钥解密:" + data);

		//3.公钥解密
		data = new String(RSAUtil.decryptByPrivateKey(dataByte, publicKey), "utf-8");
		System.out.println("公钥解密:" + data);
